...
import { BuildingOfficeIcon, ClockIcon, FireIcon, PlusIcon, StarIcon, TrashIcon, UserIcon } from "@heroicons/react/24/outline";
...
import { IconButton } from "./Button";
  ...
  const CardColumn = ({ name, id, stage, score, handleDragStart }: CardProps) => {
    return (
      <>
  ...
  const DEFAULT_CARDS: CardType[] = [
    // BACKLOG
    { name: "Look into render bug in dashboard", id: "1", stage: "backlog", score: 12 },
    { name: "SOX compliance checklist", id: "2", stage: "backlog", score: 34 },
    { name: "[SPIKE] Migrate to Azure", id: "3", stage: "backlog", score: 58 },
    { name: "Document Notifications service", id: "4", stage: "backlog", score: 11 },
    // TODO
    {
    ...
    { name: "Postmortem for outage", id: "6", stage: "todo", score: 70 },
    { name: "Sync with product on Q3 roadmap", id: "7", stage: "todo", score: 80 },
    ...
    { name: "Add logging to daily CRON", id: "9", stage: "doing", score: 61 },
    // DONE
    {
