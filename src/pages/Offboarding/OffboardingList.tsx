...
export default function OffboardingList() {
  ...
  const handleDelete = async (id: number) => {
    const record = {
      modelName: 'Offboarding', // Replace with the desired model name
      id,
    };
    ...
    try {
      ...
      setToastData({
        title: 'Offboarding have been deleted successfully',
        type: 'success',
      });
    ...
    try {
      ...
      await createRecord({
        ...
        createRecord({
          modelName: 'Log',
          data: {
            content: "Offboarding process was created successfully",
      ...
      // Handle toast success or further actions
      setToastData({
        title: 'A new offboarding have been created successfully',
        type: 'success',
      });
  ...
  const processActionMenus = [
    {
      ...
      handleClick: (id: number) => navigate(`/lifecycle/offboarding/${id}`),
    },
    {
      id: 2,
      name: 'Edit',
      ...
      handleClick: (id: number) =>
        navigate(`/lifecycle/offboarding/${id}?edit=true`),
    },
    {
      id: 3,
      name: 'Remove',
  ...
  return (
      <Container>
        ...
        {openDialog && (
          <Dialog
            title="Confirmation"
            message="Are you really want to delete this offboarding?"
            open={openDialog}
            discardButton="No"
            confirmButton="Yes"
