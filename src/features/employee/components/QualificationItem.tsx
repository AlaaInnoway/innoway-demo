...
export function NewQualificationItem(props: ListNewItem) {
    ...
    <tr className="group border-t border-t-gray-200 hover:bg-serene-50">
      ...
      <td className="py-4 px-6">
        <Input
          type="date"
          name="obtainedDate"
          value={newItem?.obtainedDate && stringToDate(newItem?.obtainedDate)}
          handleChange={onChangeField}
        />
      </td>
...
export function QualificationItem(props: ListItem) {
  const {
    index,
    item,
    editedItem,
    ...
    >
      ...
      <td className={`${cellClassName} px-6`}>
        <Input
          ...
          type="date"
          name="obtainedDate"
          value={stringToDate(item?.obtainedDate)}
          handleChange={onChangeField}
        />
      </td>
      <td className="py-4 px-6 opacity-0 group-hover:opacity-100">
