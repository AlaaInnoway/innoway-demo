...
const KanbanBoardOpportunity = <T,>({ modelName, filterData, stages, actionMenu }: KanbanBoardProps) => {
...
export default KanbanBoardOpportunity;
            ...
            <div className="group space-y-2">
              ...
              <div className="space-y-2">
                ...
                <div className="text-sm font-medium text-gray-600">{data.name}</div>
                  <div className="text-xs font-medium text-gray-500 italic">{data.expectedRevenue} $</div>
                ...
                <Badge 
                  ...
                  value={
                    data.expectedClosing ? (
                      retrieveDay(new Date(data.expectedClosing), '2-digit')+' '+
                      retrieveMonth(new Date(data.expectedClosing), 'short')+' '+
                      retrieveYear(new Date(data.expectedClosing), 'numeric')
                    ) : 'No date'
                  }
                />
                <Avatar
